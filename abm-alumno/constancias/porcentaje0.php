            ...
            <thead>
                <tr>
                   <!--  <td style ="color:black ; font-size:70%">Carrera </td> -->
                    <th style ="color:black ; font-size:70%">Materia</th>
                    <th style ="color:black ; font-size:70%">Libro</th>
                    <th style ="color:black ; font-size:70%">Folio</th>
                    <th style ="color:black ; font-size:70%">Fecha</th>
                    <th style ="color:black ; font-size:70%">Nota</th>
                    <th style ="color:black ; font-size:70%">Observacion</th>
                </tr>
            </thead>
...
<tr>
    <!-- <td style ="color:black ; font-size:70%"><?php echo $reg['Carrera']?> </td> -->
    <td style ="color:black ; font-size:70%"><?php echo $reg['Materia']?> </td>
    <td style ="color:black ; font-size:70%"><?php echo $reg['Libro']?> </td>
    <td style ="color:black ; font-size:70%"> <?php echo $reg['Folio']?></td>
    <td style ="color:black ; font-size:70%"><?php echo $reg["Fecha"] ?></td>
    <td style ="color:black ; font-size:70%"><?php echo $reg['Nota']?></td>
    <td style ="color:black ; font-size:70%"><?php echo $reg['Observaciones']?></td>
